...
export const enUS = {
  ...
  // 🦸‍♂️ Hero Section
  hero: {
    title: 'Enterprise Hosting Solutions for Growing Businesses',
    subtitle: 'Powerful, scalable hosting with 99.9% uptime guarantee and SOC2 compliance',
    description: 'Join 2M+ businesses that trust SiteGround for their mission-critical websites. From startups to Fortune 500 companies.',
    cta: 'Start Your Enterprise Journey',
